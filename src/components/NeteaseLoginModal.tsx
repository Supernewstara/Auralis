...
export const NeteaseLoginModal = ({ isOpen, onClose, onSuccess }: { isOpen: boolean; onClose: () => void; onSuccess?: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4 backdrop-blur-lg">
      <div className="bg-surface-container border border-white/10 rounded-2xl p-6 max-w-sm w-full mx-auto shadow-2xl relative">
